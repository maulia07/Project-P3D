...
public class Nutrisi extends AppCompatActivity {
    ...
    ImageView back;
    private static final String URL_BACANUTRISI = "https://himauntika.com/app/bacanutrisi.php";
    private static final String URL_KONTROL = "https://himauntika.com/app/kontrol.php";
    private static final String URL_BACAMESIN = "https://himauntika.com/app/mesinnutrisi.php";
