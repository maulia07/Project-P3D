...
public class IndexMenu extends AppCompatActivity {
    ...
    private void setupSlider() {
        ...
        //link image
        fragments.add(FragmentSlider.newInstance("http://192.168.0.3/hidroponik/gambarslide/satu.jpeg"));
        fragments.add(FragmentSlider.newInstance("http://192.168.0.3/hidroponik/gambarslide/dua.jpeg"));
        fragments.add(FragmentSlider.newInstance("http://192.168.0.3/hidroponik/gambarslide/tiga.jpeg"));
        fragments.add(FragmentSlider.newInstance("http://192.168.0.3/hidroponik/gambarslide/empat.jpeg"));
